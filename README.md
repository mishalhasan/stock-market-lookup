...
1. Clone the repository to your local machine:
   ...
   ```bash
   git clone https://github.com/mishalhasan/stock-market-lookup
   ```
...
_Note: Tailwind CSS is included via CDN in `index.html`; no separate CSS file is required._

---

## 🚀 How to Use

1. **Search for Stocks:** Enter a stock symbol (recommended) or a company name. Click **Search**. _(Example: "AAPL" or "Bank")_.
